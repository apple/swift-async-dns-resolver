...
* Commit hash
* Contextual information (e.g. what you were trying to achieve with swift-async-dns-resolver)
...
Context:
While testing my application that uses with swift-async-dns-resolver, I noticed that ...
